...
public class SetupDrainCleaner {
    ...
    public void applyInstallFiles() {
        ...
        if (DRAIN_CLEANER_DIRECTORY.equals(KUBERNETES_DIRECTORY)) {
            ...
            customDrainCleanerSecretBuilder = SecretUtils.retrieveSecretBuilderFromFile(TestConstants.DRAIN_CLEANER_NAMESPACE, certsPaths,
                TestConstants.DRAIN_CLEANER_DEPLOYMENT_NAME,
