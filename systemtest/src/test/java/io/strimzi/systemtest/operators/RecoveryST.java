...
class RecoveryST extends AbstractST {
    ...
    void testRecoveryFromImpossibleMemoryRequest() {
        ...
        if (Environment.isKafkaNodePoolsEnabled()) {
            KafkaNodePoolResource.replaceKafkaNodePoolResourceInSpecificNamespace(Environment.TEST_SUITE_NAMESPACE, KafkaNodePoolResource.getBrokerPoolName(sharedClusterName), knp ->
                knp.getSpec().setResources(resourceReq));
        } else {
